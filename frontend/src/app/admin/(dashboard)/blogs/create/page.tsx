        ...
        <div className="p-6">
          ...
          >
            ...
            <div className="xl:col-span-2 space-y-6">
              ...
              <ComponentCard
                title="Post Details"
                desc="Add the basic information of your blog post"
              >
              ...
              <ComponentCard
                title="Post Content"
                desc="Write your blog post content using the rich text editor"
              >
              ...
              <ComponentCard
                title="Metadata"
                desc="Add additional data in JSON format"
              >
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-gray-700">
  ...
  "description": "Meta description"
                  ...
                  {Object.keys(form.metadata).length > 0 && (
                    <div className="mt-3 p-3 bg-gray-50 rounded-md">
                      <p className="text-sm font-medium text-gray-700 mb-2">Current Metadata:</p>
            ...
            <div className="xl:col-span-1 space-y-6">
              ...
              <ComponentCard
                title="Blog Images"
                desc="Upload images for your blog post (up to 10 images)"
              >
                <PhotoUpload
                  label="Blog Images"
