...
import { addColor, deleteColor, getAllColors, getColorById, getProductByColor, updateColor } from "../controllers/color.controller";
...
router.route("/get/:id/products").get(getProductByColor);
