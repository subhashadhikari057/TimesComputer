...
const TopCategories = () => {
    const categories = [
      ...
      },
      {
        id: 5,
        title: "Mac",
        image: "/topcat/mac.avif"
      },
      {
        id: 6,
        title: "Keyboard",
        image: "/topcat/keyboard.jpeg"
      },
      {
        id: 7,
        title: "Mouse",
        image: "/topcat/mouse.png"
      },
      {
        id: 8,
        title: "Monitor",
        image: "/topcat/monitor.jpeg"
      }
    ];
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 md:pb-4">
        <div className="mb-8 flex justify-between items-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Top Categories</h2>
        </div>
        
        <div className="md:grid md:grid-cols-4 md:gap-6 grid grid-cols-2 gap-4 overflow-x-auto">
          {visibleCategories.map((category) => (
            <CategoryCard
              ...
              onClick={() => {}}
              className="min-h-[75px] md:min-h-[100px]"
            />
          ))}
        </div>
